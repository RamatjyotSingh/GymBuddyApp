...
CREATE MEMORY TABLE PUBLIC.LINKS_TO (
    EXERCISE_ID INTEGER NOT NULL,
    TAG_ID INTEGER NOT NULL,
    CONSTRAINT PK_LINKS_TO PRIMARY KEY (EXERCISE_ID, TAG_ID),
    CONSTRAINT FK_LINKS_TO_EXERCISE FOREIGN KEY (EXERCISE_ID) REFERENCES PUBLIC.EXERCISE(EXERCISE_ID) ON DELETE CASCADE,
    CONSTRAINT FK_LINKS_TO_TAG FOREIGN KEY (TAG_ID) REFERENCES PUBLIC.TAGS(TAG_ID) ON DELETE CASCADE
);
