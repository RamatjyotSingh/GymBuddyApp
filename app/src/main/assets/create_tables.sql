...
DROP TABLE IF EXISTS PUBLIC.SESSION_ITEM_TIME;
DROP TABLE IF EXISTS PUBLIC.SESSION_ITEM_REP;
DROP TABLE IF EXISTS PUBLIC.WORKOUTITEMS_TIME;
DROP TABLE IF EXISTS PUBLIC.WORKOUTITEMS_REP;
